...
-------------------------------------------------------------------------------
-- @function [parent=#utils] numberToBoolean
-- @param  #number value
-- @return #boolean
function t.numberToBoolean(value) return value~=0 end

-------------------------------------------------------------------------------
-- @function [parent=#utils] processSwitchLight
-- @param  #table value
-- @return #number
function t.processSwitchLight(value) 
